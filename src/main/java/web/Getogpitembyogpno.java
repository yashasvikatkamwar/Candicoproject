...
/**
 * Servlet implementation class Getogpitembyogpno
 */
@WebServlet("/Getogpitembyogpno")
public class Getogpitembyogpno extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//Ifsc_noESIC_nopf_no_abank_nameaccno
		   try
		   {
		     ...
		     System.out.println("Cimsbatchno"+rs.getObject(3));
