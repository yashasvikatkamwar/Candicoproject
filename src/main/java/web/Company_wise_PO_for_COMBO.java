...
@WebServlet("/Company_wise_PO_for_COMBO")
public class Company_wise_PO_for_COMBO extends HttpServlet {
...
{
  System.out.println("Company_wise_PO_for_COMBO=combobox===>"); 
