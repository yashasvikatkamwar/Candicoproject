...
/**
 * Servlet implementation class Getalldeliverychallan
 */
@WebServlet("/Getalldeliverychallan")
public class Getalldeliverychallan extends HttpServlet {
	
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		
		System.out.println("get all ogps"); 
		...
		//Ifsc_noESIC_nopf_no_abank_nameaccno
		   try
		   {
		      ...
		      rs=sr.view_All_delievry_challan(Cid, Fdate, Tdate);
		      //rs=sr.viewBatchs();
