											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select name="issuetype" id="issuetype"
                                                        ...
                                                        <option value="Plant issue">Plant issue</option>
											...
											<div class="form-group">
												<div class="col-sm-12 text-center">
													<!-- <button type="submit" value="save"
														class="btn btn-success addButton" onclick="updateItemsByItemCode()">Issue</button> -->
														  <button onclick="printPage()">Print</button>
														  <button type="submit" value="save" class="btn btn-success addButton" onclick="performActions()">Issue & Add</button>
...
function adddata() {
	...
	var typeofissue = document.getElementById("issuetype").value;
	var batch_no = document.getElementById("batchno").value;
