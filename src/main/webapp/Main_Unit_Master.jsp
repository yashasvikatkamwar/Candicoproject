          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                  ...
                  <h2 style="color:black;">Unit Master</h2>
                ...
                <div class="x_content">
                    <div class="text-right">
                     ...
                     <span class="small"><a data-toggle="modal" data-target="#addModel" href="jvascript:void(0);"><button class="btn fix_back_color">Add Unit</button></a></span>
                             
                           <%
                try{
                sr1=new DataService();
                rs2=sr1.unit_list_all();
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <div id="successMessage2" class="col-md-12 alert alert-success successMessage2" style="display:none">
                    <span>Unit Details Updated successfully</span>
                </div>              
                        
                <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Unit ID:<span class="required">*</span></label>
                ...
                <div class="form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12"> Unit Name:<span class="required">*</span></label>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  <div class="modal-dialog">
                     <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                           ...
                           <h3 style="display:inline"><i class="fa fa-plus m-r-5"></i> Add new Unit</h3>
                        </div>
                        <div class="modal-body">
                           <div class="row">
                              <div class="col-md-12">
                                  <form class="form-horizontal" method="post" id="customer_form" >
                                    ...
                                    <fieldset>
                                       <div class="col-md-12 form-group">
                                          ...
                                          <input type="text" autocomplete="off"  placeholder="Enter Unit" id="Unit_name" name="Unit_name" required class="form-control">
...
//                   alert("P_id==============>"+P_id);
                ...
                if (Unit == '') {
                    $("#err_Unit").show();				
                    validationArrayRewardval.push('Unit');
                    error_text = 1;
                }
