	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 style="color: black;">Tax Master</h3>
			</div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title" style="background: #e8f1f3; width: 100%">
						<h2 style="color: black;">Tax Master</h2>
						...
						<div class="text-right">
							<span class="small"><a data-toggle="modal"
								data-target="#addModel" href="jvascript:void(0);"><button
										class="btn fix_back_color">Add Tax</button></a></span>
					...
					<form id="unit_details_add" action=""
						...
						<div class="modal-body">
							<div id="successMessage2"
								...
								style="display: none">
								<span>Tax Details Updated successfully</span>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="Tid" name="Tid" required="required"
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Percent<span
									class="required">*</span></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="per" name="per" required="required"
										class="form-control col-md-7 col-xs-12">
				...
				<div class="modal-content">
					<div class="modal-header modal-header-primary">
						...
						<h3 style="display: inline">
							<i class="fa fa-plus m-r-5"></i> Add new Tax
						</h3>
					</div>
					<div class="modal-body">
						<div class="row">
								...
								<form class="form-horizontal" method="post" id="customer_form">
									...
									<fieldset>
										<div class="col-md-12 form-group">
											<label class="control-label">Tax Name</label> <input
												type="text" autocomplete="off" placeholder="Enter Name"
												id="tax_name" name="tax_name" required class="form-control">
											<span class="help-block small err" id="err_cust_name"
												style="display: none"></span>
										</div>

										<div class="col-md-12 form-group">
											<label class="control-label">Tax Percent</label> <input
												type="text" autocomplete="off"
												placeholder="Enter Tax PErcent" id="tax_per" name="tax_per"
