          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                  ...
                  <form id="demo-form3" action="Main_Bill_list.jsp"  data-parsley-validate class="form-horizontal form-label-left" style="margin-top: 1%;">
             <table>
                 <tr>
                     <td>
                        <%
...
<!--                          <body onload="addDate();">-->
                        <div class="col-xs-6">
                            <input type="date" id="Fdate" name="Fdate"  class="form-control " value="<%=Fdate%>">
                        </div>
                        <div class="col-xs-6">
                            <input type="date" id="Tdate" name="Tdate"  class="form-control " value="<%=Tdate%>">
                        </div>
                      </div>
                    </div>                
                  </td> 
                ...
                try{
                sr1=new DataService();
                rs2=sr1.BILL_list(Fdate,Tdate,Cid);
            ...
            <div class="table-responsive" style="height: 460px;">
                    ...
                    <%int i=0,hu=1;
                      ...
                      // out.println(" t====================>"+t);
                       ...
                       <tr id="<%=i%>">
                            <td ><%=i+1%></td>
                            <td><%=rs2.getObject("Bid")%></td>
                            <%String date[]=rs2.getString("Bill_date").split("-");%>
                            <td style="width: 25%"><%=date[2]+"."+date[1]+"."+date[0]%></td>
                            <td><%=rs2.getObject("Gid")%></td>
                            <td><%=rs2.getObject("invoice_no")%></td>
                            
                            
                            <%String date1[]=rs2.getString("invoice_date").split("-");%>
                            <td style="width: 25%"><%=date1[2]+"."+date1[1]+"."+date1[0]%></td>
                            
                            
                            <td><%=rs2.getObject("Vname")%></td>
                             <td><%=rs2.getObject("category")%></td>
                            <td><%=rs2.getObject("Cname")%></td>
                            <td>RS.<%=rs2.getObject("total")%></td>
                            <td><%=rs2.getObject("fright")%></td>
                            
                            <td><%=rs2.getObject("other_expences")%></td>
                            
                            <td><%=rs2.getObject("gst_code")%></td>
                            <td><%=rs2.getObject("gst_amt")%></td>
                            <td><%=rs2.getObject("bill_amt")%></td>
                              ...
                              <td class=" last">
                                  <!--<button class="btn btn-primary btn-xs btn_edit" data-toggle="modal" data-target="#unit_guard_details" value="<%=rs2.getObject(1)%>" id="<%=i%>" href="#">Edit </button>-->
                                   <!--<button class="btn btn-primary btn-xs btn_edit" data-toggle="modal" data-target="#unit_guard_details" value="<%=rs2.getObject(1)%>"  href="#">Add </button>-->
                                    ...
                                    <a href="Main_Bill_Edit.jsp?Bid=<%=rs2.getObject(1)%>"><button class=" btn btn-success btn-xs " >Edit</button></a>
                                    <!--<a href="Main_GRN_PDF_QAD.jsp?Gid=<%=rs2.getObject(1)%>"><button class=" btn btn-info btn-xs " >QAD PDF</button></a>-->
                                    <!--<a href="Main_GRN_PDF_Inward.jsp?Gid=<%=rs2.getObject(1)%>"><button class=" btn btn-info btn-xs " >Inward PDF</button></a>-->
                                    
                                    <a href="Main_BILL_PDF.jsp?Bid=<%=rs2.getObject(1)%>"><button class=" btn btn-warning btn-xs " >PDF</button></a>
                            </td>
                        </tr>
                    <%i++;}%>
