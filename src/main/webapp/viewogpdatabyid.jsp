							...
							<div class="panel-heading" id="pa"
								...
								<div class="btn-group" id="buttonexport">
									<a href="javascript:void(0)">
										<h4>
											Outward Gate Pass  <br>
											<h5>OGP No :</h5>
											<input name="ogp no" required type="text"
											...
											<div class="col-md-12" style="height: 460px;">
												<div style="margin-bottom: 20px;">
													...
													<table id="" class="inner-table-2 inventory" style="width: 100%;">
														...
														<tbody>
															<tr>
																<td><%=rs.getObject("OgpNo")%></td>
							    								<td><%=rs.getObject("Cname")%></td>
																<td><%=rs.getObject("ogpdate")%></td>
																<td><%=rs.getObject("modeOfTransport")%></td>
																<td><%=rs.getObject("Purpose")%></td>
																<td><%=rs.getObject("Remark")%></td>
								
																<td><%=rs.getObject("suplierno")%></td>
																<td><%=rs.getObject("Vehicleno")%></td>
													...
													<table class="inner-table-2 inventory" id=""style="float: left;">
														...
														<tbody>
															...
															<tr>
																...
																<td><%=data2.getString("HSN")%></td>
																<td><%=data2.getString("itemQty")%></td>
																<td><%=data2.getString("unit")%></td>
																

																<td><%=data2.getString("CIMS_batch_no")%></td>
															</tr>
															<%
															}
															%>
