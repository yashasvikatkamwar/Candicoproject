	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 style="color: black;">Vender Master</h3>
			</div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title" style="background: #e8f1f3; width: 100%">
						<h2 style="color: black;">Vender Master</h2>
						...
						<div class="text-right">
							...
							<span class="small"><a data-toggle="modal"
								data-target="#addModel" href="jvascript:void(0);"><button
										class="btn fix_back_color">Add Vender</button></a></span>
                       ...
                       while(rs2.next()){%>
							<tr id="<%=i%>">
								...
								<td class=" last">
									...
									</button> <!--<button class="btn btn-primary btn-xs btn_edit" data-toggle="modal" data-target="#unit_guard_details" value="<%=rs2.getObject(1)%>"  href="#">Add </button>-->
                               ...
                               --%>
									...
									<a
									href="MAin_Vender_manufacture_list.jsp?Vid=<%=rs2.getObject(3)%>&name=<%=rs2.getObject(2)%>"><button
											class=" btn btn-warning btn-xs ">manufactures</button></a> <!--<a href="MAin_Customer_Membership_cards_view.jsp?Cid=<%=rs2.getObject(1)%>&name=<%=rs2.getObject(3)%>"><button class=" btn btn-success btn-xs " >Memberships</button></a>-->
								</td>
							</tr>
							<%
								i++;
						...
						<div class="modal-body">
							...
							<div class="col-md-12 form-group">
								...
								<input type="text" autocomplete="off" placeholder="Enter  code"
									...
									readonly=""> <span class="help-block small err"
									id="err_cust_ph_no" style="display: none"></span>
							</div>
