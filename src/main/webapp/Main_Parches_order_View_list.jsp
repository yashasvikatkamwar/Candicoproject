			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title" style="background: #e8f1f3; width: 100%">
						...
						<form id="demo-form3" action="Main_Parches_order_View_list.jsp"
					...
					<div class="x_content">
						<div class="text-right">
							...
							<!--<span class="small"><a data-toggle="modal" data-target="#addModel" href="jvascript:void(0);"><button class="btn fix_back_color">Add Item Category</button></a></span>-->

							<%
                try{
                sr1=new DataService();
                rs2=sr1.PO_list_with_itrms(Fdate,Tdate,Cid);
                      ...
                      // out.println(" t====================>"+t);
                       while(rs2.next()){%>
								<tr id="<%=i%>">
									...
									<%String date[]=rs2.getString("datee").split("-");%>
									<td style="width: 25%"><%=date[2]+"."+date[1]+"."+date[0]%></td>
									<td><%=rs2.getObject("Com_name")%></td>
									<td><%=rs2.getObject("Vname")%></td>
									<td><%=rs2.getObject("adrs")%></td>
									<td><%=rs2.getObject("GST_no")%></td>

									<td><%=rs2.getObject("Item_name")%></td>
									<td><%=rs2.getObject("HSN")%></td>
									<td><%=rs2.getObject(27)%></td>
									<td>RS.<%=rs2.getObject(29)%></td>
									<td><%=rs2.getObject(28)%></td>
									<td>RS.<%=rs2.getInt(27)*rs2.getInt(29)%></td>

									<td><%=rs2.getObject("gst_name")%></td>
									<td><%=rs2.getObject("qty")%></td>
									<td><%=rs2.getObject("total_amt")%></td>
									<td><%=rs2.getObject("packing_charg")%></td>
									<td><%=rs2.getObject("gst_amt")%></td>
									<td><%=rs2.getObject("tcs_amt")%></td>
									<td><%=rs2.getObject("final_total")%></td>
									<td><%=rs2.getObject("remark")%></td>
                               ...
                               --%>
										...
										<a
										href="Main_Parches_order_View.jsp?Pid=<%=rs2.getObject(1)%>"><button
												class=" btn btn-warning btn-xs ">PDF</button></a> <a
										href="Main_Parches_order_Edit.jsp?Pid=<%=rs2.getObject(1)%>"><button
												class=" btn btn-success btn-xs ">Edit</button></a>
									</td>
								</tr>
								<%
									i++;
						...
						<div class="modal-body">
							...
							<div class="col-md-12 form-group">
								...
								<input type="text" autocomplete="off" placeholder="Enter  name"
									id="name1" name="name1" required class="form-control">
							...
							<div class="col-md-12 form-group">
								...
								<input type="text" autocomplete="off" placeholder="Enter  code"
									id="code1" name="code1" required class="form-control">
								<span class="help-block small err" id="err_cust_ph_no"
									style="display: none"></span>
							</div>
							...
							<div class="col-md-12 form-group">
								...
								<input type="text" autocomplete="off"
									placeholder="Enter Tax mob" id="mob1" name="mob1" required
									class="form-control"> <span
									class="help-block small err" id="err_cust_ph_no"
									style="display: none"></span>
							</div>
							...
							<div class="col-md-12 form-group">
								...
								<input type="text" autocomplete="off" placeholder="Enter email"
									id="email1" name="email1" required class="form-control">
								<span class="help-block small err" id="err_cust_ph_no"
									style="display: none"></span>
							</div>
							...
							<div class="col-md-12 form-group">
								<label class="control-label">Company Name</label> <input
									type="text" autocomplete="off" placeholder="Enter Company"
									id="com1" name="com1" required class="form-control"> <span
									class="help-block small err" id="err_cust_ph_no"
									style="display: none"></span>
							</div>
							...
							<div class="col-md-12 form-group">
								...
								<textarea name="desc1" id="desc1" class="form-control"
									placeholder="Item  Description" cols="30" rows="1"></textarea>
							...
							<div class="col-md-12 form-group">
								...
								<!--<textarea name="email" id="email" class="form-control" placeholder="Item  Description" cols="30" rows="1"></textarea>-->
								<input type="text" autocomplete="off"
									placeholder="Enter Address" id="adrs1" name="adrs1" required
									class="form-control"> <span
									class="help-block small err" id="err_cust_ph_no"
									style="display: none"></span>
							</div>
							...
							<div class="col-md-12 form-group">
								<label class="control-label">GST NO</label> <input type="text"
									autocomplete="off" placeholder="Enter GST NO" id="gst1"
									name="gst1" required class="form-control"> <span
									class="help-block small err" id="err_cust_ph_no"
									style="display: none"></span>
							</div>
				...
				<div class="modal-content">
					<div class="modal-header modal-header-primary">
						...
						<h3 style="display: inline">
							<i class="fa fa-plus m-r-5"></i> Add new Vender
						</h3>
					</div>
					<div class="modal-body">
						<div class="row">
								...
								<form class="form-horizontal" method="post" id="customer_form">
									...
									<fieldset>
										...
										<div class="col-md-12 form-group">
											...
											<!--<textarea name="code" id="code" class="form-control" placeholder="Item  Name" cols="30" rows="1"></textarea>-->
											<input type="text" autocomplete="off"
												placeholder="Enter  code" id="code" name="code" required
												class="form-control"> <span
												class="help-block small err" id="err_cust_ph_no"
												style="display: none"></span>
										</div>
										...
										<div class="col-md-12 form-group">
											...
											<!--<textarea name="mob" id="mob" class="form-control" placeholder="Item  Description" cols="30" rows="1"></textarea>-->
											<input type="text" autocomplete="off"
												placeholder="Enter Tax mob" id="mob" name="mob" required
												class="form-control"> <span
												class="help-block small err" id="err_cust_ph_no"
												style="display: none"></span>
										</div>
										...
										<div class="col-md-12 form-group">
											<label class="control-label">Company Name</label> <input
												type="text" autocomplete="off" placeholder="Enter Company"
												id="com" name="com" required class="form-control"> <span
												class="help-block small err" id="err_cust_ph_no"
												style="display: none"></span>
										</div>
										...
										<div class="col-md-12 form-group">
											...
											<!--<textarea name="email" id="email" class="form-control" placeholder="Item  Description" cols="30" rows="1"></textarea>-->
											<input type="text" autocomplete="off"
												placeholder="Enter Address" id="adrs" name="adrs" required
												class="form-control"> <span
												class="help-block small err" id="err_cust_ph_no"
												style="display: none"></span>
										</div>
										...
										<div class="col-md-12 form-group">
											<label class="control-label">GST NO</label> <input
												type="text" autocomplete="off" placeholder="Enter GST NO"
												id="gst" name="gst" required class="form-control"> <span
												class="help-block small err" id="err_cust_ph_no"
												style="display: none"></span>
										</div>
