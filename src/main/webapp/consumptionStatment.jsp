							...
							<table id="stockTable"
										...
										<thead>
											<tr class="headings fix_back_color">
												...
												<th>Unit</th>
												<th>Avg Rate </th>
												<th colspan="2">Opening Stocks</th>
												<!-- <th>Base Unit of Measure</th> -->
												<th colspan="2">Purchess Stocks</th>
										...
										<tbody>
											...
											try {
												sr1 = new DataService();
												rs2=sr1.consumptionReportFromGRN(Fdate, Tdate, company_id);
												rsmd = rs2.getMetaData();
												x = rsmd.getColumnCount();
												int no = 1, i = 0;
											...
											<tr>
												...
												while (rs2.next()) {
													...
													double orderdQty= Double.parseDouble(rs2.getString("QTY_ordered"));
													double rate=Double.parseDouble(rs2.getString("rate"));
													
													
													double totalOpAmt= orderdQty * rate;
												%>
												<td><%=no++%></td>
