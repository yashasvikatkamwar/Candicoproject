									...
									<div class="row">
									  <div class="col-md-12">
									    <div class="alert alert-danger" id="err"
											...
											<label for="month" class="col-sm-2 control-label">Type of
											...
											<div class="form-group">
												<!--product code-->
												<label for="month" class="col-sm-2 control-label">Batch No
													: <span class="required">*</span>
												</label>
												...
												<label for="month" class="col-sm-2 control-label">CIMN Batch No
													: <span class="required">*</span>
												</label>

												<div class="col-sm-4">

													<input name="cimn_batch_no" required type="text"
														class="form-control" id="batchno"> <span
														id="err_cust_no" style="color: red;"></span>
												</div>
											...
											<div class="form-group">
												...
												<label for="date" class="col-sm-2 control-label"> Return Date
													: <span class="required">*</span>
												</label>
												<div class="col-sm-4">
													...
													<div class="input-group date" data-date-format="dd/mm/yyyy">
														<input type="date-text" class="form-control"
															placeholder="dd/mm/yyyy" name="Return_date" id="Return_date" required>
											...
											<div class="form-group">
												<div class="col-sm-12 text-center">
													<button type="submit" value="save"
														class="btn btn-success addButton ">Return</button>
