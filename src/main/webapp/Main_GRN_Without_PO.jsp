...
//                                                                                                 if(rs.next()){Gid= rs.getString(1) != null ? rs.getString(1):"1";}
                                                                                               %>
                                                                                            <input  autocomplete="off"   name="Gid" required type="number"  class="form-control" id="Gid">
											...
											<div class="col-sm-4">
                                                                                            <input  autocomplete="off" readonly=""  name="Pid"  type="text" value=""  class="form-control" id="Pid">
                                                                                            <input  autocomplete="off" readonly=""  name="Pid_sr"  type="hidden" value=""  class="form-control" id="Pid_sr">
											...
											<div class="col-sm-4">
                                                                                            ...
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="document_date" id="document_date" >
											...
											<div class="col-sm-4">
                                                                                            ...
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="posting_date" id="posting_date" >
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <input  autocomplete="off" readonly=""  name="Vname" required type="text"  class="form-control" id="Vname">
                                                                                            <input  readonly=""  name="vender" required type="hidden"   class="form-control" id="vender">
												<!--<span class="small"><a data-toggle="modal" data-target="#adduser" href="jvascript:void(0);">Add new customer</a></span>-->
												<span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                        ...
                                                                                        <label for="cust_id" id="cust_id_label" class="col-sm-2 control-label">
                                                                                            <!--<div class="col-sm-9">-->
                                                                                                 <%
                                                                                                        ...
                                                                                                        rs=ds1.Company_list();
                                                                                                %>
                                                                                                <select name="select_company" id="select_company" class="form-control form-inline col-sm-3"  onchange="company_chnge()" style="width: 49%;top: -7px;background: #f8f6c4;">
                                                                                                   <!--<optgroup label="storage_location">-->
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <input   readonly=""  name="Cname" required type="text"  class="form-control" id="Cname">
                                                                                            <input  readonly=""  name="com" required type="hidden"   class="form-control" id="com">
												<!--<span class="small"><a data-toggle="modal" data-target="#adduser" href="jvascript:void(0);">Add new customer</a></span>-->
												<span id="err_cust_id" style="color:red;"></span>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-4">
                                                                                            <input    name="delevery_challan_no"  type="text"   class="form-control" id="delevery_challan_no">
												<!--<span class="small"><a data-toggle="modal" data-target="#adduser" href="jvascript:void(0);">Add new customer</a></span>-->
												<span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
											...
											<div class="col-sm-4">
                                                                                            ...
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="challan_date" id="challan_date" >
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <input   name="bill_no"  type="text"   class="form-control" id="bill_no">
												<span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                     <div>
											...
											<div class="col-sm-4">
                                                                                            ...
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="Bill_date" id="Bill_date" >
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="LR_no"  type="text"   class="form-control" id="LR_no">
												<span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            ...
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="LR_date" id="LR_date">
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="transport_name"  type="text"   class="form-control" id="transport_name">
												<span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="vehicle_no"  type="text"   class="form-control" id="vehicle_no">
												<span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
										</div>
											...
											<div class="col-sm-4">
                                                                                            <input   name="way_bill_no"  type="text"   class="form-control" id="way_bill_no">
												<span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            ...
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="way_bill_date" id="way_bill_date" >
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <input   name="header_text"  type="text"   class="form-control" id="header_text">
												<span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
                                                                                                   ...
                                                                                                   <option value="">Select Items</option>
                                                                                                                 <%
                                                                                                                  while(rs.next()){
                                                                                                                      ...
                                                                                                                      Object f=rs.getObject("item_name")+" ( "+rs.getObject("Iid")+" )";
                                                                                                                 %>
                                                                                                        <option value="<%=o%>"><%=f%></option>
                                                                                                                   <%}%> 
                                                                                                      <!--</optgroup>-->
...
<!--                                                                    <tr id="<%=i%>" onclick="edit_btn(<%=i%>)" class="row_tr">
                                                                                    ...
                                                                                    <td style="background: #efefef;"><span >Item_name</span></td>
								...
								<!--</div>-->					
											...
											<div class="col-sm-12">
												<dl class="dl-horizontal">
												  ...
												  <dt>Local Freight:</dt>
												  <dd>
                                                                                                      &#8377; <span  name="local_freight" id="local_freight" contenteditable="" >0.00</span><br>
                                                                                                   </dd>
                                                                                            </dl>
												  ...
												  <dd>
                                                                                                      &#8377; <span  name="other_expensess" id="other_expensess" contenteditable="" onkeyup="final_total()">0.00</span><br>
                                                                                                   </dd>
                                                                                            </dl>
