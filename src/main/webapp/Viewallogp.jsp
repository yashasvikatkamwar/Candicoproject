				...
				<div class="x_panel">
					<div class="x_title" style="background: #e8f1f3; width: 100%">
						...
						<%
                              ...
                              rs2=sr1.view_All_ogp(company_id, Fdate, Tdate);
							...
							%>
							<tr id="<%=i%>">
							     <td><%=rs2.getObject("OgpNo")%></td>
							    <td><%=rs2.getObject("Cname")%></td>
								<td><%=rs2.getObject("ogpdate")%></td>
								<td><%=rs2.getObject("modeOfTransport")%></td>
								<td><%=rs2.getObject("Purpose")%></td>
								<td><%=rs2.getObject("Remark")%></td>
								
								<td><%=rs2.getObject("suplierno")%></td>
									<td><%=rs2.getObject("Vehicleno")%></td>
								
								<td class=" last">

                <!-- Print Button -->
    <a href="ogpPrint.jsp?ogpno=<%=rs2.getObject("OgpNo")%>"><button value="<%=rs2.getObject("OgpNo")%>"
