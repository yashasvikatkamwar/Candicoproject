...
%>
<%!ResultSet data,rs;DataService ds1;ArrayList ar;Iterator ity;Object o1=null;String Qid; %>
                     ...
                     <div class="panel panel-bd lobidrag">
                        <div class="panel-heading" id="pa" style="background-color: #e8f1f3  ; border-bottom: black" >
                           <div class="btn-group" id="buttonexport">
                              <a href="javascript:void(0)">
                                 <h4>QUALITY CONTROL DEPARTMENT EDIT</h4>
                              </a>
                           </div>
                        </div>
                        <div class="panel-body" class="row" style="background-color : #ffffff;"> 
                           ...
                           <div class="btn-group">
                            ...
                            ds1= new DataService();
                           data=ds1.QCD_Details(Qid);
                            if(data.next()){
                            %>
                            <form class="form-horizontal " id="demo-form3"  method="post" >
							      <input type="hidden" name="sr" id="sr" value="<%=Qid%>" > 
										...
										<div id="info"></div>
                                                                                  ...
                                                                                  <div class="form-group">   
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                             <%
                                                                                                        ...
                                                                                                        rs=ds1.Company_list();
                                                                                                %>
                                                                                                <select name="select_company" id="select_company" class="form-control form-inline col-sm-3 select2"  onchange="company_chnge()" disabled="">
                                                                                                   <!--<optgroup label="storage_location">-->
                                                                                                   <option value=""><%=data.getObject("Cname")%></option>
                                                                                                                 <%
                                                                                                                  while(rs.next()){
											...
											<div class="col-sm-4">
                                                                                            <select name="stock_type" id="stock_type" class="form-control form-inline col-sm-3">
                                                                                                   ...
                                                                                                   <option><%=data.getObject("stock_type")%></option>
											...
											<div class="col-sm-4">
                                                                                            <select name="Gid" id="Gid" class="form-control form-inline col-sm-3 select2" onchange="GRN_chnge()" disabled="" >
                                                                                                   <!--<optgroup label="GRN">-->
                                                                                                   <option><%=data.getObject("Gid")%></option>
											...
											<span id="err_cust_id" style="color:red;"></span>
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-sm-4">
                                                                                            <select name="items" id="items" class="form-control form-inline col-sm-3 "  onchange="Iid_chnge()" disabled="">
											...
											<div class="col-sm-4">
                                                                                            <input    name="MFG_name"  type="text"   class="form-control" id="MFG_name" value="<%=data.getObject("MFG_name")%>" readonly="">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>											
											...
											<div class="col-sm-4">
                                                                                            <input    name="Iid" required type="text"   class="form-control" id="Iid"value="<%=data.getObject("Iid")%>" readonly="">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="Iname" required type="text"   class="form-control" id="Iname" value="<%=data.getObject("Iname")%>" readonly="">
											...
											<div class="col-sm-4">
                                                                                            <input    name="CIMS_batch_no"  type="text"   class="form-control" id="CIMS_batch_no" value="<%=data.getObject("CIMS_batch_no")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="vender_batch_no"  type="text" class="form-control" id="vender_batch_no" value="<%=data.getObject("vender_batch_no")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
										</div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="no_of_container"  type="text"   class="form-control" id="no_of_container" value="<%=data.getObject("no_of_container")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="MFG_date" id="MFG_date"  value="<%=dateFormateChnge(data.getString("MFG_date"))%>">
											...
											<div class="col-sm-4">
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="expiry_date" id="expiry_date"  value="<%=dateFormateChnge(data.getString("expiry_date"))%>">
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="MFG_retest_date" id="MFG_retest_date"  value="<%=dateFormateChnge(data.getString("MFG_retest_date"))%>">
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="received_QTY"  type="text" class="form-control" id="received_QTY" value="<%=data.getObject("received_QTY")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="AR_no"  type="text" class="form-control" id="AR_no" value="<%=data.getObject("AR_no")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="sample_QTY"  type="text"   class="form-control" id="sample_QTY" value="<%=data.getObject("sample_QTY")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
										</div>
											...
											<div class="col-sm-4">
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="sample_date" id="sample_date" value="<%=dateFormateChnge(data.getString("sample_date"))%>">
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="RELEASED_REJECTED_DATED" id="RELEASED_REJECTED_DATED" value="<%=dateFormateChnge(data.getString("RELEASED_REJECTED_DATED"))%>">
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <select name="result" id="result" class="form-control form-inline col-sm-3">
                                                                                                   <!--<optgroup label="stock_type">-->
                                                                                                   <option><%=data.getObject("result")%></option>
											...
											<div class="col-sm-4">
                                                                                            <div class="input-group date" data-date-format="dd.mm.yyyy">
                                                                                                <input  type="text" class="form-control" placeholder="dd/mm/yyyy" name="REANALYSIS_DATE" id="REANALYSIS_DATE" value="<%=dateFormateChnge(data.getString("REANALYSIS_DATE"))%>">
                                                                                                <div class="input-group-addon" >
                                                                                                  <span class="glyphicon glyphicon-th"></span>
                                                                                                </div>
                                                                                            </div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="LOT_QTY"  type="text"   class="form-control" id="LOT_QTY" value="<%=data.getObject("LOT_QTY")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
										</div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="RELEASED_QTY"  type="text" class="form-control" id="RELEASED_QTY" value="<%=data.getObject("RELEASED_QTY")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
                                                                                    <div>
											...
											<div class="col-sm-4">
                                                                                            <input    name="REJECTED_QTY"  type="text"   class="form-control" id="REJECTED_QTY" value="<%=data.getObject("REJECTED_QTY")%>">
                                                                                            <span id="err_cust_id" style="color:red;"></span>
											</div>
                                                                                    </div>
										</div>
