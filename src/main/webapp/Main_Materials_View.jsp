	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h3 style="color: black;">Materials View</h3>
			</div>
			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					<div class="x_title" style="background: #e8f1f3; width: 100%">
						<h2 style="color: black;">ALL Materials View</h2>

						<div class="clearfix"></div>
					</div>
					<div class="x_content">
						<div class="text-right">
							<form id="demo-form3" action="Main_Materials_Add.jsp"
								data-parsley-validate class="form-horizontal form-label-left">



								<center>
									<button type="submit" class="btn  fix_back_color">+Materials
										Form</button>
						...
						<table id="example"
							...
							<tr id="<%=i%>">
								...
								<td><%=rs2.getObject(4)%> Rs.</td>
								<td><%=rs2.getObject(5)%></td>


								<td><%=rs2.getObject(6)%> Rs.</td>
						...
						<div class="modal-body">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<div id="err_c_id" class="err-msg">Please enter Material
										name</div>
								</div>
							</div>
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Unit.:<span
									class="required">*</span></label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<!--<input type="text" id="unit" name="unit" required="required" class="form-control col-md-7 col-xs-12">-->
									<select
										class="form-control col-md-7 col-xs-12 input-field select2"
										placeholder="UNIT name" id="unit" name="unit">
										<%
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Material
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									...
									<select
										class="form-control col-md-7 col-xs-12 input-field select2"
										placeholder="SElect Material type" id="type" name="type">
										<%
											System.out.println("in gate page form");
											ds1 = new DataService();
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">Basic
									Rate :<span class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="basic_rate" name="basic_rate"
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12">GST:<span
									class="required">*</span>
								</label>
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="gst" name="gst" required="required"
										class="form-control col-md-7 col-xs-12" onkeyup="calculate()">
							...
							<div class="form-group">
								...
								<div class="col-md-6 col-sm-6 col-xs-12">
									<input type="text" id="total_rate" name="total_rate"
										required="required" class="form-control col-md-7 col-xs-12"
										readonly="">
									<div id="err_PF_No" class="err-msg">Please enter
										total_rate</div>
								</div>
							</div>
							...
							<div class="modal-footer">
								...
								<button type="submit" class="btn btn-success ad_dtl_sbmt">Update
								</button>
