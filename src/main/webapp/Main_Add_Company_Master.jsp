...
<!--           <form id="demo-form3" action="main_Add_color.jsp" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                <div class="x_title">
                  <h2 style="color:black;">Company Master</h2>
...
<form id="" method="post" action="Add_Company_master" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
...
<!--         <div class="col-md-3">
 ...
 <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                      <div class="label-div">
                        <label for="company-Short Name" class="form-label">
                          Short Name</label
                        >
                      </div>
                    </div>
