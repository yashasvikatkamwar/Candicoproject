										...
										<div class="col-md-12">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													...
													<select name="com" id="com" class="form-control select2"
														...
														<optgroup label="">
															...
															<%
																while (rs.next()) {
																	Object ven = rs.getString("code") + "=>" + rs.getString(3) + "=>" + rs.getString(5);
												...
												<div class="col-sm-4">
													...
													%>
													<input autocomplete="off" name="CPid" required
														type="number" class="form-control" id="CPid"> <span
											...
											<div class="form-group">
												...
												<label for="month" class="col-sm-2 control-label">GST
													: <span class="required">*</span>
												</label>
												...
												<div class="col-sm-4">
													...
													<select name="vender" id="vender"
														...
														<optgroup label="">
															...
															<%
																while (rs.next()) {
																	Object ven = rs.getString("code") + "=>" + rs.getString(2);
												...
												<div class="col-sm-4">
													...
													<select name="item" id="item"
														...
														<optgroup label="select Item">
															...
															<%
																while (rs.next()) {
																	String o = rs.getObject("Iid") + "=>" + rs.getObject(2) + "=>" + rs.getObject(3) + "=>"
																			+ rs.getObject(4);
																	String f = rs.getObject(2) + " (" + rs.getObject("Iid") + ")";
															%>
															<option value="<%=o%>"><%=f%></option>
															<%
																}
											...
											<div class="form-group">
												...
												<div class="col-sm-8">
													<textarea name="remark" value="" class="form-control"
														placeholder="" id="remark"></textarea>
										...
										<div class="col-md-6">
											...
											<div class="col-sm-12">
												<dl class="dl-horizontal">
													<dt>Total:</dt>
													<dd>
														&#8377; <span name="tot" id="tot">0.00</span><br>
													</dd>
												</dl>
												<dl class="dl-horizontal">
													<dt>Freight/Packing:</dt>
													<dd>
														&#8377; <span name="Total_Freight" id="Total_Freight"
												...
												<dl class="dl-horizontal">
													<dt>GST amount:</dt>
													<dd>
														&#8377; <span name="GST/IGST" id="gst_tot">0.00</span><br>
													</dd>
												</dl>
												<dl class="dl-horizontal">
													<dt>
												...
												<dl class="dl-horizontal">
													<dt>Total amount:</dt>
													<dd>
														&#8377; <span name="Total_Amount" id="Total_Amount">0.00</span><br>
													</dd>
												</dl>
											</div>
									...
									<div class="row">
										<div class="col-sm-3">
											<%
												...
												rs = ds1.Item_Master_list();
											%>
											<select name="itemA" id="itemA"
												class="select2 form-control form-inline">
												<optgroup label="select Item">
													<option value="">-- Select --</option>
													<%
														while (rs.next()) {
										...
										<input type="button" value="Add Date" class="btn-info btn"
											onclick="generateTableRow_Date()"> <input
											type="button" value="Copy" class="btn-warning btn"
											onclick="Copy_table()" style="float: right">
										<div class="col-md-12"
											style="height: 400px; overflow-x: scroll; overflow-y: scroll">
...
<script>
						...
						$('form#demo-form3')
								.submit(
										function() {
											...
											var tot = document
													.getElementById("tot").innerHTML;
											var gst_amt = document
													.getElementById("gst_tot").innerHTML;
											var TCS_tax = document
													.getElementById("TCS_tax").innerHTML;
											var Total_Freight = document
													.getElementById("Total_Freight").innerHTML;
											var final_total = document
													.getElementById("Total_Amount").innerHTML;
											var Total_Quantity = document
													.getElementById("Total_Quantity").innerHTML;
											...
											if (vender != ""
												...
												var obj = [];
												for (var a = document
														.querySelectorAll('table.inventory tbody tr'), i = 0; a[i]; ++i) {
												...
												var objA = [];
												for (var a = document
														.querySelectorAll('table.inventory2 tbody tr'), i = 0; a[i]; ++i) {
													// get inventory row cells
													cells = a[i]
															.querySelectorAll('span:last-child');
													//                var dict={};
													...
													var qtys = cells[3].innerHTML
															.split("<br>");
													var Adates = cells[4].innerHTML
															.split("<br>");
	...
	$(document)
			.ready(
					function() {
						...
						function quan() {
							// alert("call");
							var Item_Size = document
									.getElementById("Item_Size").value;
							//   alert("From_Date===>"+From_Date1);

							var Item_Color = document
									.getElementById("Item_Color").value;
							// alert("Item_Color===>"+Item_Color);

							var Finished_Grade_Item = document
									.getElementById("Finished_Grade_Item").value;
							...
							xhttp.onreadystatechange = function() {
								if (this.readyState == 4 && this.status == 200) {
									...
									var a = document
											.getElementById("quantity1").innerHTML = this.responseText;
									document.getElementById("quantity1").value = a;
									var a = document
											.getElementById("Total_Quantity").innerHTML = this.responseText;
									document.getElementById("Total_Quantity").value = a;
									//alert("p===>"+p);
								}
							};
							var url = "invoice_quantity_combo?Item_Size="
									+ Item_Size + "&Item_Color=" + Item_Color
									+ "&Finished_Grade_Item="
									+ Finished_Grade_Item;
	...
	function add_customer() {
		...
		$.ajax({
			...
			success : function(data) {
				//alert(data);
				$('#successMessage').html('Data inserted successfully').delay(
						5000).fadeOut();
				$('#successMessage').show();
				$('#cust_name').val("");
				$('#cust_ph_no').val("");
	...
	function generateTableRow() {
		...
		emptyColumn.innerHTML = '<td><a class="cut" onclick="cuting(this);">-</a><span ></span></td>'
				...
				+ unit
				+ '</span></td>'
				+ '<td ><span contenteditable onkeyup="calculate_table_amt()">'
				+ rate
				+ '</span></td>'
	...
	function generateTableRow_Date() {
		...
		if (date) {
            ...
            // Set the reformatted date as the input field's value
            date.value = datef;
            
            // You can also log or use the reformatted date for further operations
            console.log("Reformatted Date: " + datef);
        }
		console.log(date)
		...
		emptyColumn.innerHTML = '<td><a class="cut" onclick="cuting_Date(this);">-</a><span ></span></td>'
				+ '<td style="background: #efefef;"><span contenteditable>'
				+ name
				+ '</span></td>'
		...
		document.querySelector('table.inventory2 tbody').appendChild(
				emptyColumn);
	}
	...
	function Copy_table() {
		...
		for (var a = document.querySelectorAll('table.inventory tbody tr'), i = 0; a[i]; ++i) {
			...
			emptyColumn.innerHTML = '<td><a class="cut" onclick="cuting_Date(this);">-</a><span ></span></td>'
					...
					+ qty
					+ '</span></td>'
					+ '<td style="background: #efefef;"><span contenteditable><input type="date"></span></td>'
					+ '<td ><span ></span></td>'
					+ '<td><span contenteditable></span></td>';
			document.querySelector('table.inventory2 tbody').appendChild(
					emptyColumn);
								...
								.change(
										function() {
											...
											$('#desi')
													...
													.end()
													.append(
															'<option value="whatever">Data</option>')
													.val(' ');
															...
															$
																	.each(
																			...
																			function(
																					i,
																					data) {
																				var div_data = '<option value="'+data.text+'">'
																						+ data.text
																						+ '</option>';
																				$(
																						div_data)
	...
	function final_total() {
		...
		var Total_Amount = Number(total) + Number(TCS_tax) + Number(txt_total)
				+ Number(Freight);
		...
		document.getElementById("Total_Amount").innerHTML = Math
				.round(Total_Amount);
	...
	function getPOID() {
		...
		$.ajax({
			type : "POST",
			url : "Company_next_PO_ID_get_COMBO",
			data : {
				Cid : Cid
			},
			dataType : "json",
			success : function(data) {
				$.each(data.aaData, function(i, data) {
					...
					document.getElementById("CPid").value = data.text;
				});
			}
