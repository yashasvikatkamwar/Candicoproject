		...
		<div class="content-wrapper">        
			...
			<section class="content lobipanel">
				<div class="row">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select name="com" id="com" class="form-control select2" readonly
					...
					<!-- onclick="save()" -->	<label for="cust_id" id="cust_id_label" 
													class="col-sm-2 control-label">Proposed Work Date:
													<span class="required">*</span>
												</label>
												<div class="input-group date" data-date-format="dd/mm/yyyy">
														<input type="date-text" class="form-control"
															placeholder="dd/mm/yyyy" name="pwdate" id="pwdate"  readonly>
											...
											<div class="form-group">
												...
												<label for="item_unit_id" class="col-sm-2 control-label">Product Code :</label>
											  <div class="col-sm-4">
										        <select  id="item11" name="item11" class="select2 select2_single form-control" readonly>
											    ...
											    <label for="cust_id" id="cust_id_label" class="col-sm-2 control-label">Batch no. : <span class="required">*</span></label>
											 <div class="col-sm-4">
												<select name="batchcode" id="batchcode" class="form-control select2" readonly>
													<optgroup label="">
														<option value="">-- Select --</option>
														<option value=""></option>
													</optgroup>
									...
									<div class="form-group">
									  ...
									  <label for="cust_id" id="cust_id_label" class="col-sm-2 control-label">Expiry Date : <span class="required">*</span></label>
											<div class="col-sm-4">
												<div class="input-group date" data-date-format="dd/mm/yyyy">
														<input type="date-text" class="form-control" placeholder="dd/mm/yyyy" name="expdt" id="expdt"  readonly>
														<div class="input-group-addon">
															<span class="glyphicon glyphicon-th"></span>
														</div>
												</div>
												...
												<div class="col-sm-4">
													...
													<input autocomplete="off" name="pn" readonly
														type="text" class="form-control" id="pn"> <span
											...
											<div class="form-group">
												<label for="cust_id" id="cust_id_label"
													class="col-sm-2 control-label">Department : <span class="required">*</span></label>
												<div class="col-sm-4">
													
												<input autocomplete="off" name="department" id="department" type="text" class="form-control" readonly>
												...
												<label for="cust_id" id="cust_id_label"
													class="col-sm-2 control-label">Date of Manufacture:
													<span class="required">*</span>
												</label>
												<div class="input-group date" data-date-format="dd/mm/yyyy">
														<input type="date-text" class="form-control" placeholder="dd/mm/yyyy" name="dom" id="dom"  readonly>
														<div class="input-group-addon">
															<span class="glyphicon glyphicon-th"></span>
														</div>
													</div>
											...
											<table class="inner-table-2 inventory" id="detailsTBL">
												<thead>
													<tr>
														...
														<th colspan="2" style="text-align: center;">Issue Detail</th>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<center>
													<div class="col-sm-12">
													  <button type="submit" value="save" class="btn btn-success addButton" onclick="updateretermineqnty()">Issue & Add</button>
...
$(document).ready(function() {
    ...
    function populateTable(data, dateColumnName) {
        ...
        $.each(data, function(index, item) {
            ...
            row.append($("<td>").text(item.five).attr("id", "ID2"));
            //alert(item.seven);
	...
	function fetchworkorder(batchCode){
        $.ajax({
            type: "POST", 
            url: "Getworkorderbybatchcode", 
            data: {
            	Bcode : batchCode
            },
            dataType: "json",
            success: function(response) {
                // $("#Ori").empty();
                  ...
                  $.each(response.Data, function(index, item) {
                    $('#pwdate').val(item.proposedworkdate);
                    $('#department').val(item.dpt);
...
<script>
function updateretermineqnty() {
    var elementsWithID3 = document.querySelectorAll('td[id="ID3"]');
    var redetermineqty = [];
    elementsWithID3.forEach(function(element) {
        redetermineqty.push(element.textContent);
    });

    var elementsWithID1 = document.querySelectorAll('td[id="ID1"]');
    var cimsbatchno = [];
    elementsWithID1.forEach(function(element) {
        cimsbatchno.push(element.textContent);
    });
    
    alert(redetermineqty);
    alert(cimsbatchno);

    $.ajax({
        type: "POST",
        url: "Updateredetermineqty",
        data: {
            redetermineqty: redetermineqty,
            cimsbatchno: cimsbatchno
        },
