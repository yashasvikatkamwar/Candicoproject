...
<%!ResultSet rs, rq, data, data2, data3, data4, data5, re, selectData, rs2, comName;
												...
												<div class="col-sm-4">
													...
													<select name="com" id="com" class="form-control select2"
														...
														<optgroup label="">
															...
															comName = sr1.Company_list_ById(Ccode);
															%>
															<%
															
															while(comName.next()){
														%>
															<option value="<%= Ccode %>" selected="" ><%=comName.getString("Cname") + "(" + Ccode + ")"%></option>
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<select name="item" id="item"
														...
														onchange="generateTableRow();" readonly="readonly">
														...
														%>
														<option disabled value="<%=value%>"><%=rs2.getObject("item_name")%></option>
														<%
															}
														%>
											...
											<div class="form-group">
												<div class="col-sm-12 text-center">
													<button type="submit" value="update"
														class="btn btn-success update "  id="Update">Update</button>
				...
				$.each(response.dataprod, function(Index,prod){
					...
					tableData = tableData + '<tr>';
					 ...
					 //tableData = tableData +   '<td id="itemId">'+prod.item+'</td> ';
	              	...
	              	tableData = tableData +   '<td id="itemId" hidden="">'+prod.item+'</td> ';
	              	  tableData = tableData +  '</tr>';
				});
	   ...
	   // alert("batchNo>>>" + batchNo);
	    ...
	    if (productName !==null && com !==null) {
	        ...
	        for (var i = 0; i < table.rows.length; i++) {
	           ...
	           // alert(row);
	            var rowData = {
	                "iName": row.cells[1].textContent,
	                "qty": row.cells[2].textContent,
	                "unit": row.cells[3].textContent,
	                "iId" : row.cells[4].textContent
	            };
	           // console.log(rowData);
	            data.push(rowData);
	        ...
	        $.ajax({
	            ...
	            success : function(data) {
					...
					$('#successMessage').show();
					$("#spinner").hide();
					location.href="viewProductQa.jsp";
