...
%>
<%!ResultSet data,rs;DataService ds1;ArrayList ar;Iterator ity;Object o1=null;String Gid; Double total=0.0; %>
...
//                                                                                        System.out.println("st >>"+st);
											...
											<div class="form-group">
												<label for="date" class="col-sm-2 control-label">Bill
												...
												<div class="col-sm-4">
													<%
                                                                                               ...
                                                                                               %>
													<input autocomplete="off" name="Bid" required type="number"
														value="<%=Bid%>" class="form-control" id="Bid"> <span
											...
											<div class="form-group">
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">GRN ID : <span
														class="required">*</span></label>
													<div class="col-sm-4">
														<input autocomplete="off" readonly="" name="Gid" required
															type="text" value="<%=data.getObject("Gid")%>"
												...
												<div>
													...
													<div class="col-sm-4">
														<input readonly="" name="Cname" required type="text"
															...
															value="<%=data.getObject("Com_id")%>=><%=data.getObject("com_name")%>=><%=data.getObject("CshortN")%>"
											...
											<div class="form-group">
												<label for="cust_id" id="cust_id_label"
													class="col-sm-2 control-label">Vender Code: <span
													class="required">*</span></label>

												<div class="col-sm-4">
													<input autocomplete="off" readonly="" name="Vid" required
														type="text" value="<%=data.getObject("Vid")%>"
														class="form-control" id="Vid">
													<!--<span class="small"><a data-toggle="modal" data-target="#adduser" href="jvascript:void(0);">Add new customer</a></span>-->
													<span id="err_cust_id" style="color: red;"></span>
												</div>
												<label for="cust_id" id="cust_id_label"
													class="col-sm-2 control-label">Vender Name: <span
													class="required">*</span></label>
												<div class="col-sm-4">
													<input autocomplete="off" readonly="" name="Vname" required
														type="text" value="<%=data.getObject("Vname")%>"
														class="form-control" id="Vname">
											...
											<div class="form-group">
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Invoice NO:</label>
													<div class="col-sm-4">
														<input name="invoice_no" type="text" class="form-control"
															id="invoice_no" value="<%=data.getObject("bill_no")%>">
														<span id="err_cust_id" style="color: red;"></span>
													</div>
												</div>
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Invoice Date:</label>
													<div class="col-sm-4">
														<%
															String date[] = data.getString("Bill_date").split("-");
																String Bill_date = date[2] + "/" + date[1] + "/" + date[0];
														%>
														<div class="input-group date"
															data-date-format="dd.mm.yyyy">
															<input type="text" class="form-control"
																placeholder="dd/mm/yyyy" name="invoice_date"
																id="invoice_date" value="<%=Bill_date%>">
															<div class="input-group-addon">
																<span class="glyphicon glyphicon-th"></span>
															</div>
														</div>
												...
												<div>
													...
													<div class="col-sm-4">
														<input name="category" type="text" class="form-control"
															id="category"> <span id="err_cust_id"
											...
											<table class="inner-table-2 inventory" id="detailsTBL">
												...
												<tbody>
													...
													<tr id="<%=i%>" onclick="edit_btn(<%=i%>)" class="row_tr">
														...
														<td><span contenteditable=""><%=rs.getString("total_amt")%></span></td>
														<td><span contenteditable=""></span></td>
													</tr>
													<%
														total = total + rs.getDouble("total_amt");
													%>
													<%
														i++;
															}
									...
									<div class="row"
										...
										<div class="col-md-6">
											...
											<div class="col-sm-4">
												...
												<label for="month" class="col-sm-4 control-label">GST
										...
										<div class="col-md-6">
											<div class="col-sm-12">
												<dl class="dl-horizontal">
													<dt>Total:</dt>
													<dd>
														&#8377; <span name="total" id="total" contenteditable=""><%=total%></span><br>
													</dd>
												</dl>
												<!--                                                                                            <dl class="dl-horizontal">
												...
												<dl class="dl-horizontal">
													<dt>GST amount:</dt>
													<dd>
														&#8377; <span name="gst_amt" id="gst_amt">0.00</span><br>
														<span name="gst_per" id="gst_per" hidden="">0.00</span> <span
															name="gst_code" id="gst_code" hidden="">0.00</span>
												...
												<dl class="dl-horizontal">
													<dt>Bill amount:</dt>
													<dd>
														&#8377; <span name="bill_amt" id="bill_amt"
												...
												<dl class="dl-horizontal">
													<dt>Local Freight:</dt>
													<dd>
														&#8377; <span name="fright" id="fright" contenteditable=""
															onkeyup="final_total()">0.00</span><br>
													</dd>
												</dl>
												...
												<dl class="dl-horizontal">
													...
													<dd>
														&#8377; <span name="other_expences" id="other_expences"
