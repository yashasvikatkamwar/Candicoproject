...
//                                                                                        System.out.println("st >>"+st);
											...
											<div class="form-group">
												<label for="date" class="col-sm-2 control-label">GRN
												...
												<div class="col-sm-4">
													<%
                                                                                               ...
                                                                                               %>
													<input autocomplete="off" name="Gid" required type="number"
														value="<%=Gid%>" class="form-control" id="Gid"> <span
														id="err_inv_date" style="color: red;"></span>
												</div>
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">PO ID : <span
														class="required">*</span></label>
													<div class="col-sm-4">
														<input autocomplete="off" readonly="" name="Pid"
															type="text" value="<%=data.getObject("Pid")%>"
															class="form-control" id="Pid"> <input
															autocomplete="off" readonly="" name="Pid_sr"
															type="hidden" value="<%=Pid%>" class="form-control"
															id="Pid_sr">
											...
											<div class="form-group">
												<label for="date" class="col-sm-2 control-label">Document
												...
												<div class="col-sm-4">
													...
													<div class="input-group date" data-date-format="dd.mm.yyyy">
														<input type="text" class="form-control"
															placeholder="dd/mm/yyyy" name="document_date"
															id="document_date">
												...
												<label for="date" class="col-sm-2 control-label">Posting
													Date : <span class="required">*</span>
												</label>
												<div class="col-sm-4">
													<!--<body onload="addDate();"/>-->
													...
													<div class="input-group date" data-date-format="dd.mm.yyyy">
														<input type="text" class="form-control"
															placeholder="dd/mm/yyyy" name="posting_date"
															id="posting_date">
														<div class="input-group-addon">
															<span class="glyphicon glyphicon-th"></span>
														</div>
											...
											<div class="form-group">
												<label for="cust_id" id="cust_id_label"
													class="col-sm-2 control-label">Vender : <span
													class="required">*</span></label>

												<div class="col-sm-4">
													<input autocomplete="off" readonly="" name="Vname" required
														type="text" value="<%=data.getObject("Vname")%>"
														class="form-control" id="Vname"> <input
														readonly="" name="vender" required type="hidden"
														value="<%=data.getObject("vid")%>=><%=data.getObject("Vname")%>"
														class="form-control" id="vender">
													<!--<span class="small"><a data-toggle="modal" data-target="#adduser" href="jvascript:void(0);">Add new customer</a></span>-->
													<span id="err_cust_id" style="color: red;"></span>
												</div>
												...
												<label for="cust_id" id="cust_id_label"
													...
													class="required">*</span></label>
												<div class="col-sm-4">
													<input readonly="" name="Cname" required type="text"
														value="<%=data.getObject("Com_name")%>"
														class="form-control" id="Cname"> <input
														readonly="" name="com" required type="hidden"
														value="<%=data.getObject("Com_id")%>=><%=data.getObject("Com_name")%>=><%=data.getObject("Com_short_name")%>"
											...
											<div class="form-group">
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Delivery Chalan No
														: </label>
													<div class="col-sm-4">
														<input name="delevery_challan_no" type="text"
															class="form-control" id="delevery_challan_no">
														<!--<span class="small"><a data-toggle="modal" data-target="#adduser" href="jvascript:void(0);">Add new customer</a></span>-->
														<span id="err_cust_id" style="color: red;"></span>
													</div>
												</div>
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Challan Date</label>
													<div class="col-sm-4">
														<!--<input   name="challan_date"  type="date"   class="form-control" id="challan_date">-->
														<div class="input-group date"
															data-date-format="dd.mm.yyyy">
															<input type="text" class="form-control"
																placeholder="dd/mm/yyyy" name="challan_date"
																id="challan_date">
															<div class="input-group-addon">
																<span class="glyphicon glyphicon-th"></span>
															</div>
											...
											<div class="form-group">
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Bill NO:</label>
													<div class="col-sm-4">
														<input name="bill_no" type="text" class="form-control"
															id="bill_no"> <span id="err_cust_id"
															style="color: red;"></span>
													</div>
												</div>
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Bill Date:</label>
													<div class="col-sm-4">
														<!--<input    name="Bill_date" required type="date"   class="form-control" id="Bill_date">-->
														<div class="input-group date"
															data-date-format="dd.mm.yyyy">
															<input type="text" class="form-control"
																placeholder="dd/mm/yyyy" name="Bill_date" id="Bill_date">
															<div class="input-group-addon">
																<span class="glyphicon glyphicon-th"></span>
															</div>
														</div>
											...
											<div class="form-group">
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">LR NO:</label>
													<div class="col-sm-4">
														<input name="LR_no" type="text" class="form-control"
															id="LR_no"> <span id="err_cust_id"
															style="color: red;"></span>
													</div>
												</div>
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">LR Date:</label>
													<div class="col-sm-4">
														<!--<input     name="LR_date" required type="date"   class="form-control" id="LR_date">-->
														<div class="input-group date"
															data-date-format="dd.mm.yyyy">
															<input type="text" class="form-control"
																placeholder="dd/mm/yyyy" name="LR_date" id="LR_date">
															<div class="input-group-addon">
																<span class="glyphicon glyphicon-th"></span>
															</div>
														</div>
											...
											<div class="form-group">
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Transport Name : </label>
													<div class="col-sm-4">
														<input name="transport_name" type="text"
															class="form-control" id="transport_name"> <span
															id="err_cust_id" style="color: red;"></span>
													</div>
												</div>
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Vehicle No:</label>
													<div class="col-sm-4">
														<input name="vehicle_no" type="text" class="form-control"
															id="vehicle_no"> <span id="err_cust_id"
															style="color: red;"></span>
													</div>
												</div>
											</div>
											<div class="form-group">
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Way Bill NO: </label>
													<div class="col-sm-4">
														<input name="way_bill_no" type="text" class="form-control"
															id="way_bill_no"> <span id="err_cust_id"
															style="color: red;"></span>
													</div>
												</div>
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Way Bill Date : </label>
													<div class="col-sm-4">
														<!--<input     name="way_bill_date" required type="date"   class="form-control" id="way_bill_date">-->
														<div class="input-group date"
															data-date-format="dd.mm.yyyy">
															<input type="text" class="form-control"
																placeholder="dd/mm/yyyy" name="way_bill_date"
																id="way_bill_date">
															<div class="input-group-addon">
																<span class="glyphicon glyphicon-th"></span>
															</div>
											...
											<div class="form-group">
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">Header Text : </label>
													<div class="col-sm-4">
														<input name="header_text" type="text" class="form-control"
															id="header_text"> <span id="err_cust_id"
															style="color: red;"></span>
													</div>
												</div>
												<div>
													<label for="cust_id" id="cust_id_label"
														class="col-sm-2 control-label">No of Container : </label>
													<div class="col-sm-4">
														<input name="total_container" type="text"
															class="form-control" id="total_container"> <span
															id="err_cust_id" style="color: red;"></span>
													</div>
												</div>
											</div>
											...
											<table class="inner-table-2 inventory" id="detailsTBL">
												...
												<tbody>
													...
													<tr id="<%=i%>" onclick="edit_btn(<%=i%>)" class="row_tr">
														...
														<td style="background: #efefef;"><span><%=rs.getString("Item_name")%></span></td>
														...
														<td><span></span></td>
														<td><span></span></td>
														<td><span><%=rs.getString("rem_qty")%></span></td>
														...
														<td><span><%=rs.getString("qty")%></span></td>
														<td><span><%=rs.getString("unit")%></span></td>
														<td><span><%=rs.getString("received_qty")%></span></td>
														<td><span></span></td>
														<td><span></span></td>
									...
									<div class="row">
										<div class="col-sm-12">
											<!--<div class="wrapper">-->
											<ul class="tabs">
												<li><a href="javascript:void(0); return false;"
													rel="#tabcontent1" class="tab active">Material</a></li>
												<li><a href="javascript:void(0); return false;"
													rel="#tabcontent2" class="tab">Quantity</a></li>
												<li><a href="javascript:void(0); return false;"
													rel="#tabcontent3" class="tab">where</a></li>
												<li><a href="javascript:void(0); return false;"
													rel="#tabcontent4" class="tab">Purchase Order Data</a></li>
												<li><a href="javascript:void(0); return false;"
													rel="#tabcontent5" class="tab">Partner</a></li>
												<li><a href="javascript:void(0); return false;"
													rel="#tabcontent6" class="tab">Batch</a></li>
												<li><a href="javascript:void(0); return false;"
													rel="#tabcontent7" class="tab">Cost Assignment</a></li>
											...
											<input type="button" class="btn btn-success" value="Save"
												style="float: right;" onclick="update_table_row()">
											<input type="button" class="btn btn-success"
												value="Add New Row" style="float: right;"
												onclick="Add_table_row()"> <input type="hidden"
												id="row_id">
											<div class="tab_content_container">
												<div class="tab_content tab_content_active" id="tabcontent1">
													<div class="col-md-12">
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Material
																:</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="Iname" type="text"
																	class="form-control" id="Iname" readonly=""> <span
																	id="err_cust_id" style="color: red;"></span>
															</div>
															<!--<label for="cust_id" id="cust_id_label" class="col-sm-2 control-label">Company : <span class="">*</span></label>-->
															<div class="col-sm-2">
																<input autocomplete="off" name="Iid" type="text"
																	class="form-control" id="Iid" readonly=""> <input
																	autocomplete="off" name="HSN" type="hidden"
																	class="form-control" id="HSN" readonly=""> <span
																	id="err_cust_id" style="color: red;"></span>
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Vendor
																Material No. :</label>
															<div class="col-sm-3">
																<input autocomplete="off" name="vender_metrial_no"
																	type="text" class="form-control" id="vender_metrial_no">
																<span id="err_cust_id" style="color: red;"></span>
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">MPN
																MATERIAL :</label>
															<div class="col-sm-2">
																<input autocomplete="off" name="MPN_material"
																	type="text" class="form-control" id="MPN_material">
																<span id="err_cust_id" style="color: red;"></span>
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																...
																Group :</label>
															<div class="col-sm-2">
																<input autocomplete="off" name="material_grup"
																	type="text" class="form-control" id="material_grup">
																<span id="err_cust_id" style="color: red;"></span>
															</div>
															<div class="col-sm-7 control-label">
																<label for="cust_id" id="cust_id_label"
																	class="col-sm-6 control-label">Valuation Type:</label>
																<div class="col-sm-6">
																	<input autocomplete="off" name="valuation_type"
																		type="text" class="form-control" id="valuation_type">
																	<span id="err_cust_id" style="color: red;"></span>
																</div>
																<label for="cust_id" id="cust_id_label"
																	class="col-sm-6 control-label">EAN in order
																	unit:</label>
																<div class="col-sm-6">
																	<input autocomplete="off" name="EAN_in_order_unit"
																		type="text" class="form-control"
																		id="EAN_in_order_unit"> <span id="err_cust_id"
																		style="color: red;"></span>
																</div>
																<label for="cust_id" id="cust_id_label"
																	class="col-sm-6 control-label">EAN Check:</label>
																<div class="col-sm-6">
																	<input autocomplete="off" name="EAN_check" type="text"
																		class="form-control" id="EAN_check"> <span
																		id="err_cust_id" style="color: red;"></span>
																</div>
															</div>
														</div>
												...
												<div class="tab_content" id="tabcontent2">
													<div class="col-md-12">
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Qty
																in Delivery Note:</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="QTY_in_delivery_note"
																	type="text" class="col-sm-8" id="QTY_in_delivery_note">
																<input autocomplete="off" name="QTY_in_delivery_note1"
																	type="text" class="col-sm-4" id="QTY_in_delivery_note1">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Qty
																in Unit Of Entry :</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="QTY_in_unit_of_Entry"
																	type="text" class="col-sm-8" id="QTY_in_unit_of_Entry"
																	onkeyup="short_cal()"> <input
																	autocomplete="off" name="QTY_in_unit_of_Entry1"
																	type="text" class="col-sm-4" id="QTY_in_unit_of_Entry1">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																...
																in SKU :</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="QTY_in_SKU" type="text"
																	class="col-sm-8" id="QTY_in_SKU"> <input
																	autocomplete="off" name="QTY_in_SKU1" type="text"
																	class="col-sm-4" id="QTY_in_SKU1">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Short
																QTY:</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="QTY_in_short"
																	type="text" class="col-sm-8" id="QTY_in_short">
																<input autocomplete="off" name="QTY_in_short1"
																	type="text" class="col-sm-4" id="QTY_in_short1">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Quantity
																Ordered :</label>
															<div class="col-sm-4">
																<input name="QTY_ordered" type="text" class="col-sm-8"
																	id="QTY_ordered" readonly="" style="background: beige;">
																<input name="QTY_ordered11" type="text" class="col-sm-4"
																	id="QTY_ordered1" style="background: beige;">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">GR
																Quantity :</label>
															<div class="col-sm-4">
																<input name="GR_QTY" type="text" class="col-sm-8"
																	id="GR_QTY" style="background: beige;" readonly="">
																<!--<input  autocomplete="off" name="GR_QTY1"  type="text"   class="col-sm-4" id="GR_QTY1">-->
															</div>
															<label for="cust_id" id="cust_id_label"
																class="col-sm-2 control-label" style="text-align: left;">No.
																Containers :</label>
															<div class="col-sm-2">
																<input autocomplete="off" name="No_containers"
																	type="text" class="col-sm-8" id="No_containers">
																<input autocomplete="off" name="No_containers1"
																	type="text" class="col-sm-4" id="No_containers1">
															</div>
														</div>
												...
												<div class="tab_content" id="tabcontent3">
													<div class="col-md-12">
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Movement
																Type :</label>
															<div class="col-sm-2">
																<select name="Movement_type" type="text"
																	class="form-control" id="Movement_type">
															...
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label">Stock Type :</label>
															<div class="col-sm-3">
																<select name="stock_type" type="text"
																	class="form-control" id="stock_type">
														...
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Plant
																:</label>
															<div class="col-sm-6">
																<input autocomplete="off" name="plant" type="text"
																	class="col-sm-8" id="plant"> <input
																	autocomplete="off" name="plant_id" type="text"
																	class="col-sm-4" id="plant_id">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Storage
																Location :</label>
															<div class="col-sm-9">
																<input autocomplete="off" name="storage_location"
																	type="text" class="col-sm-6" id="storage_location">
																<input autocomplete="off" name="storage_location_id"
																	type="text" class="col-sm-2" id="storage_location_id">
																<%
                                                                                                        ds1= new DataService();
                                                                                                        rs=ds1.Company_list();
                                                                                                %>
																<select name="storage" id="storage"
																	class="form-control form-inline col-sm-3"
																	onchange="store_chnge()" style="width: 30%;">
														...
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Goods
																recipient:</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="goods_recipient"
																	type="text" class="form-control" id="goods_recipient">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Unloading
																Point:</label>
															<div class="col-sm-6">
																<input autocomplete="off" name="unloading_point"
																	type="text" class="form-control" id="unloading_point">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Text
																:</label>
															<div class="col-sm-8">
												...
												<div class="tab_content" id="tabcontent4">
													<div class="col-md-12">
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Purchase
																Order :</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="Vname" type="text"
																	class="col-sm-6" id="Vname"> <input
																	autocomplete="off" name="Vname" type="text"
																	class="col-sm-3" id="Vname">
															</div>
															<label for="cust_id" id="cust_id_label"
																class="col-sm-2 control-label" style="text-align: left;">Item
																Category :</label>
															<div class="col-sm-3">
																<input autocomplete="off" name="item_category"
																	type="text" class="form-control" value="Standard"
																	id="item_category">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">"Del.Completed"
																Ind. :</label>
															<div class="col-sm-3">
																<select autocomplete="off" name="Del_Completed_Ind"
																	type="text" class="form-control" id="Del_Completed_Ind">
														...
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Requistioner
																:</label>
															<div class="col-sm-3">
																<input autocomplete="off" name="Requistioner"
																	type="text" class="form-control" value="Standard"
																	id="Requistioner">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Cert.
																enclosed?:</label>
															<div class="col-sm-3">
																<select autocomplete="off" name="Cent_enclosed"
																	type="text" class="form-control" id="Cent_enclosed">
																	<option></option>
																	<option>YES</option>
																	<option>NO</option>
																</select>
															...
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label">Supplier's COA</label>
														</div>
													</div>
												</div>
													...
													<div class="col-md-12">
														<!--                                                                                    <div class="form-group">   
                                                                                        <label for="cust_id" id="cust_id_label" class="col-sm-3 control-label" style="text-align: left;">Vendor :</label>
                                                                                            <div class="col-sm-4">
                                                                                                <input  autocomplete="off" name=""  type="text"   class="col-sm-8" id="" value="<%=data.getObject("Vname")%>">
                                                                                                 <input  autocomplete="off" name=""  type="text"   class="col-sm-4" id="" value="<%=data.getObject("vid")%>" >
                                                                                             </div>
                                                                                     </div>-->
														<div class="form-group">
															...
															<div class="col-sm-4">
																...
																%>
																<select name="vmanu" id="vmanu"
																	class="form-control form-inline"
																	onchange="Vmanu_chnge()">
														...
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Manufactures
																:</label>
															<div class="col-sm-8">
																<input autocomplete="off" name="Manufacturer_name"
																	type="text" class="col-sm-4" id="Manufacturer_name">
																<input autocomplete="off" name="Manufacturer_id"
																	type="text" class="col-sm-3" id="Manufacturer_id">
																<input autocomplete="off" name="Manufacturer_adrs"
																	type="text" class="col-sm-5" id="Manufacturer_adrs">
															</div>
														</div>
													</div>
												</div>
												...
												<div class="tab_content" id="tabcontent6">
													<div class="col-md-12">
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Batch
																:</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="Batch" type="text"
																	class="col-sm-8" id="Batch"> <input
																	autocomplete="off" type="button" value="generate"
																	class="col-sm-3 btn btn-info" onclick="random_number()">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																...
																Batch :</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="vender_Batch"
																	type="text" class="col-sm-10" id="vender_Batch">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Date
																of Manufactures :</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="Date_of_manufacture"
																	type="text" class="col-sm-8" id="Date_of_manufacture">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Retest
																Date :</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="retest_date" type="text"
																	class="col-sm-8" id="retest_date">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">SLED/BBED
																:</label>
															<div class="col-sm-4">
																<input autocomplete="off" name="SLED_BBD" type="text"
																	class="col-sm-8" id="SLED_BBD">
															</div>
														</div>
														<!--                                                                                    <div class="form-group">   
												...
												<div class="tab_content" id="tabcontent7">
													<div class="col-md-12">
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Rate
																:</label>
															<div class="col-sm-3">
																<input autocomplete="off" name="rate" type="text"
																	class="form-control" id="rate" onkeyup="Item_cal()">
															</div>
															<label for="cust_id" id="cust_id_label"
																class="col-sm-2 control-label" style="text-align: left;">Basic
																Amt :</label>
															<div class="col-sm-3">
																<input autocomplete="off" name="basic_amt" type="text"
																	class="form-control" id="basic_amt">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">GST
																:</label>
															<div class="col-sm-3">
																<%
																	ds1 = new DataService();
																		rs = ds1.Tax_list();
																%>
																<select autocomplete="off" name="tax" type="text"
																	class="form-control" id="tax" onchange="Item_cal()">
														...
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																...
																Amt. :</label>
															<div class="col-sm-3">
																<input autocomplete="off" name="gst_amt" type="text"
																	class="form-control" id="gst_amt">
															</div>
														</div>
														<div class="form-group">
															<label for="cust_id" id="cust_id_label"
																class="col-sm-3 control-label" style="text-align: left;">Total
																Amt. :</label>
															<div class="col-sm-3">
																<input autocomplete="off" name="total_amt" type="text"
																	class="form-control" id="total_amt">
															</div>
														</div>
													</div>
												</div>
									...
									<div class="row"
										style="background-color: aliceblue; padding-top: 2%;">
										<div class="form-group">
											<label for="date" class="col-sm-2 control-label">FREIGHT
												: <span class="required">*</span>
											</label>
											<div class="col-sm-4">
												<!--<body onload="addDate();"/>-->
												<input autocomplete="off" name="freight" type="text"
													class="form-control" id="freight" onkeyup="final_total()">
												<span id="err_inv_date" style="color: red;"></span>
											</div>

											<label for="month" class="col-sm-2 control-label">FREIGHT
											...
											<div class="col-sm-4">
												<%
													ds1 = new DataService();
														rs = ds1.Tax_list();
												%>
												<select name="freight_tax" id="freight_tax"
													class="select2 select2_single form-control"
													onchange="final_total()">
										...
										<div class="col-md-6">
											<div class="col-sm-12">
												<dl class="dl-horizontal">
													<dt>Total:</dt>
													<dd>
														&#8377; <span name="total" id="total">0.00</span><br>
													</dd>
												</dl>
												<dl class="dl-horizontal">
													...
													<dd>
														...
														<span name="gst_per_freight" id="gst_per_freight"
															hidden="">0.00</span>
													</dd>
												</dl>
												<dl class="dl-horizontal">
													<dt>
														<input class=" other_charge " id="tcsChek" type="checkbox"
															name="tcsChek" onclick="final_total();" checked="">
														TCS (0.10%):
													</dt>
													<dd>
												...
												<dl class="dl-horizontal">
													<dt>Bill amount:</dt>
													<dd>
														&#8377; <span name="bill_amt" id="bill_amt">0.00</span><br>
													</dd>
												</dl>
												...
												<dl class="dl-horizontal">
													<dt>Local Freight:</dt>
													<dd>
														&#8377; <span name="local_freight" id="local_freight"
															contenteditable="">0.00</span><br>
													</dd>
												</dl>
												...
												<dl class="dl-horizontal">
													...
													<dd>
														&#8377; <span name="other_expensess" id="other_expensess"
															contenteditable="" onkeyup="final_total()">0.00</span><br>
													</dd>
												</dl>
											...
											<div class="col-sm-12" hidden="">
												<dl class="dl-horizontal">
													...
													<dd>
														<input name="hid_total_quantity" type="hidden"
															id="hid_total_quantity"> <span class=""
															id="Total_Quantity" name="Total_Quantity"></span>
													</dd>
												</dl>
											</div>
										</div>
												...
												<center>
													...
													<div class="col-sm-12">
														<button type="submit" value="save"
															class="btn btn-success invoice_btn ">Add</button>
