                    ...
                    <%int i=0,hu=1;
                      ...
                      // out.println(" t====================>"+t);
                       ...
                       <tr id="<%=i%>">
                            ...
                            <td><%=rs2.getObject("vender_metrial_no")%></td>
                            <td><%=rs2.getObject("MPN_material")%></td>
                            <td><%=rs2.getObject("material_grup")%></td>
                            <td><%=rs2.getObject("valuation_type")%></td>
                            <td><%=rs2.getObject("EAN_in_order_unit")%></td>
                            <td><%=rs2.getObject("EAN_check")%></td>
                            
                            <td><%=rs2.getObject("QTY_in_delivery_note")%></td>
                            <td><%=rs2.getObject("QTY_in_delivery_note1")%></td>
                            <td><%=rs2.getObject("QTY_in_unit_of_Entry")%></td>
                            <td><%=rs2.getObject("QTY_in_unit_of_Entry1")%></td>
                            <td><%=rs2.getObject("QTY_in_SKU")%></td>
                            <td><%=rs2.getObject("QTY_in_SKU1")%></td>
                            <td><%=rs2.getObject("QTY_in_short")%></td>
                            <td><%=rs2.getObject("QTY_in_short1")%></td>
                            <td><%=rs2.getObject("QTY_ordered")%></td>
                            <td><%=rs2.getObject("QTY_ordered1")%></td>
                            
                            <td><%=rs2.getObject("GR_QTY")%></td>
                            <td><%=rs2.getObject("No_containers")%></td>
                            <td><%=rs2.getObject("No_containers1")%></td>
                            <td><%=rs2.getObject("Movement_type")%></td>
                            <td><%=rs2.getObject("stock_type")%></td>
                            <td><%=rs2.getObject("plant")%></td>
                            <td><%=rs2.getObject("plant_id")%></td>
                            <td><%=rs2.getObject("storage_location")%></td>
                            <td><%=rs2.getObject("storage_location_id")%></td>
                            <td><%=rs2.getObject("goods_recipient")%></td>
                            
                            <td><%=rs2.getObject("unloading_point")%></td>
                            <td><%=rs2.getObject("text")%></td>
                            <td><%=rs2.getObject("item_category")%></td>
                            <td><%=rs2.getObject("Del_Completed_Ind")%></td>
                            <td><%=rs2.getObject("Requistioner")%></td>
                            <td><%=rs2.getObject("Cent_enclosed")%></td>
                            <td><%=rs2.getObject("Manufacturer_id")%></td>
...
<!--                                  <button class="btn btn-primary btn-xs btn_edit" data-toggle="modal" data-target="#unit_guard_details" value="<%=rs2.getObject(1)%>" id="<%=i%>" href="#">Edit </button>
                               ...
                               --%>    
                                    ...
                                    <a href="Main_GRN_PDF_Details.jsp?GIid=<%=rs2.getObject("GRN_items.sr")%>&Gid=<%=Gid%>"><button class=" btn btn-warning btn-xs " >PDF</button></a>
                                    <!--<a href="Main_Parches_order_Edit.jsp?Pid=<%=rs2.getObject(1)%>"><button class=" btn btn-success btn-xs " >Edit</button></a>-->
                            </td>
                        </tr>
                    <%i++;}%>
