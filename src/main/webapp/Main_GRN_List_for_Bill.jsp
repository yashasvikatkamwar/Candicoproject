          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                ...
                <div class="x_content">
                  <br />
                  <form id="demo-form3" action="Main_Bill_form.jsp"   data-parsley-validate class="form-horizontal form-label-left">
...
<!--                          <div class="col-md-1"></div>
                   ...
                   <div class="col-md-5 col-sm-6 col-xs-12 inline" >
                       <select name="Gid" id="Gid" class=" form-control  col-md-7 col-xs-12 " required="" style="    top: 13px;">
                          <!--<optgroup label="select Purches Order ID">-->
                              <option  disabled="" style="color:black;">select GRN ID</option>
                          <!--</optgroup>-->
                        </select>
                     </div>
