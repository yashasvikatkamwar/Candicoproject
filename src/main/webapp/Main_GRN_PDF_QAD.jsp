...
<div class="page-title">
          ...
          <div class="clearfix"></div>
            ...
            <div class="text-right">
                        <input type="button" class="DTTT_button" onclick="createPDF()"  id="btnExport" value="Export to PDF" >
...
<div style="padding: 0px; text-align: center;font-size: 24px; font-weight: bold;">Candico (I) Limited</div>
...
<div style="padding: 0px; text-align: center;font-size: 13px; font-weight: bold;">Inward Gate Pass cum Quality Control Statement </div>

<div class="grid-container">
  <div class="grid-item">From : Store</div>
  <div class="grid-item" style="text-align: center">To : Q.C.D</div>
  <div class="grid-item" style="text-align: right">IGP/GEN No : <%=data.getString("Gid")%></div>
  
  <div class="grid-item">Vehicle No : <%=data.getString("vehicle_no")%></div>
  <div class="grid-item" style="text-align: center"></div>
  <%String date[]=data.getString("posting_date").split("-");%>
  <div class="grid-item" style="text-align: right">Date : <%=date[2]+"."+date[1]+"."+date[0]%></div> 
</div>
...
<!--    <table width="100%" style="font-family: sans-serif;" cellpadding="10">
    ...
    <br>
    <table class="items table-bordered " width="100%" style="border-collapse: collapse;" cellpadding="23">
        <thead>
              <tr>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding: 0px 7px; line-height: 20px;"><%=data.getString("Vname")%></td>
                <td style="padding: 0px 7px; line-height: 20px;"><%=data.getString("delevery_challan_no")%></td>
                <%String date1[]=data.getString("posting_date").split("-");%>
                <td style="padding: 0px 7px; line-height: 20px;"><%=date1[2]+"."+date1[1]+"."+date1[0]%></td>
         ...
         <tr style="color: #ffffff00">
            <td style="text-align: center; color: #fff0;padding: 0px 7px; line-height: 20px;" ><%=row_count+1%></td>
            <td> </td>
            <td> </td>
            <td> </td>
            <td> </td>
         ...
         <%row_count++;}%>
         <tr >
            <td style="padding: 0px 7px; line-height: 20px;" >QCD: <Br>Intimated: Date</td>
            <td> </td>
            <td> </td>
            <td> </td>
            <td> </td>
         ...
         <tr style="text-align: center;padding: 0px 7px; line-height: 20px;">
    ...
    <div class="grid-container" style="position: absolute;bottom: 0px;width: -webkit-fill-available;">
        <div class="grid-item" style="border-top: 1px solid black;padding: 6px;">Remedial action in case of deviation </div>
        <div class="grid-item"style="border-top: 1px solid black;"></div>
        <div class="grid-item"style="border-top: 1px solid black;"></div>
        
        <div class="grid-item"style="border-top: 1px solid black;padding: 6px;">Final Decision</div>
        <div class="grid-item"style="border-top: 1px solid black;"><input type="checkbox"><label for="vehicle1">Accepted</label></div>
        <div class="grid-item"style="border-top: 1px solid black;"><input type="checkbox"><label for="vehicle1">Rejected</label></div>
        
        <div class="grid-item"style="border-top: 1px solid black;padding: 6px;">Analyst By:<br>Date :</div>
        <div class="grid-item"style="border-top: 1px solid black;"></div>
        <div class="grid-item"style="border-top: 1px solid black;text-align:right"><br><br>H.O.D.(Q.C.D.)</div>
 ...
 <%}} catch(Exception y){out.println("exception"+y);
...
//        var sTable2 = document.getElementById('tab2').innerHTML;
        ...
        style = style + ".copy{position: relative;  height:1005px; margin: 10mm 6mm 10mm 6mm;} ";
         style = style + "div.box {position: absolute;text-align: center;box-sizing: border-box;width:20%;height:50px;"
        style = style + "border: 1px solid #ddd;top:5%;font-size: 80%;padding:6px;} ";
        
         style = style + "div.box2 {position: absolute;text-align: center;box-sizing: border-box;width:19%;height:50px;"
...
//        style = style + "body{ margin: 0mm;} ";
        ...
        style = style + ".table, th, td {border: solid 1px #00000070; border-collapse: collapse; text-align: center; padding: 0px 7px; line-height: 20px;}";
        
//        style = style + "padding: 4px 4px;}"; 
//        style = style +"@page {size: 7in 9.25in;margin: 10mm 6mm 10mm 6mm;} ";
        style = style + "h1, .h1, h2, .h2, h3, .h3 {margin-top: 1px;margin-bottom: 1px;}";             
        style = style + "td{padding-left: 5px;}";
        style = style +".grid-container{display: grid;grid-template-columns: auto auto auto;padding: 10px;font-size: 12px; font-weight: bold;color: black; }";
        style = style + "</style>";
...
function inWords (num) {
    ...
    if (!n) return; var str = '';
    str += (n[1] != 0) ? (a1[Number(n[1])] || b1[n[1][0]] + ' ' + a1[n[1][1]]) + 'crore ' : '';
    str += (n[2] != 0) ? (a1[Number(n[2])] || b1[n[2][0]] + ' ' + a1[n[2][1]]) + 'lakh ' : '';
    str += (n[3] != 0) ? (a1[Number(n[3])] || b1[n[3][0]] + ' ' + a1[n[3][1]]) + 'thousand ' : '';
    str += (n[4] != 0) ? (a1[Number(n[4])] || b1[n[4][0]] + ' ' + a1[n[4][1]]) + 'hundred ' : '';
    str += (n[5] != 0) ? ((str != '') ? 'and ' : '') + (a1[Number(n[5])] || b1[n[5][0]] + ' ' + a1[n[5][1]]) + 'only ' : '';
    return str.toUpperCase();
}

    function amt_convert(no) {
//       alert("in amt_convert"+no);
    document.getElementById('word_amt').innerHTML ="RUPEES "+inWords(no.toString());
};
